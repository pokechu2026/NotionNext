...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 900, // 預設每 15 分鐘更新，避免正常流量反覆觸發 Notion 重建；必要時可用環境變數覆寫。
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI教學,生成式AI,AI顧問,VR製作,AI工作坊,選擇之丘,Choosehill,Chase Chao', // 网站关键词 英文逗号隔开
